    ...
    class GOBLIN_ESSENCE
    {
        public static string GetProps(int pos_item)
        {
            ...
            try
            {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[119].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[119].elementFields[k] == "init_strength")
                    {
                        init_strength = MainWindow.eLC.GetValue(119, pos_item, k);
                        if (init_strength != "0")
                        {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[119].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[119].elementFields[k] == "init_agility")
                    {
                        init_agility = MainWindow.eLC.GetValue(119, pos_item, k);
                        if (init_agility != "0")
                        {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[119].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[119].elementFields[k] == "init_tili")
                    {
                        init_tili = MainWindow.eLC.GetValue(119, pos_item, k);
                        if (init_tili != "0")
                        {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[119].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[119].elementFields[k] == "init_energy")
                    {
                        init_energy = MainWindow.eLC.GetValue(119, pos_item, k);
                        if (init_energy != "0")
                        {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[119].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[119].elementFields[k] == "price")
                    {
                        string price = MainWindow.eLC.GetValue(119, pos_item, k);
                        if (price != "0")
                        {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[119].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[119].elementFields[k] == "default_skill1")
                    {
                        string default_skill1 = MainWindow.eLC.GetValue(119, pos_item, k);
                        if (default_skill1 != "0")
                        {
                            line += "\n" + Extensions.SkillName(Convert.ToInt32(default_skill1)) + String.Format(Extensions.GetLocalization(7067), 1);
                        }
                        string default_skill2 = MainWindow.eLC.GetValue(119, pos_item, k + 1);
                        if (default_skill2 != "0")
                        {
                            line += "\n" + Extensions.SkillName(Convert.ToInt32(default_skill2)) + String.Format(Extensions.GetLocalization(7067), 1);
                        }
                        string default_skill3 = MainWindow.eLC.GetValue(119, pos_item, k + 2);
                        if (default_skill3 != "0")
                        {
