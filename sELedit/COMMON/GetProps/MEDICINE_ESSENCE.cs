    ...
    class MEDICINE_ESSENCE
    {
        public static string GetProps(int pos_item)
        {
            ...
            try
            {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[12].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[12].elementFields[k] == "require_level")
                    {
                        string require_level = MainWindow.eLC.GetValue(12, pos_item, k);
                        if (require_level != "0")
                        {
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[12].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[12].elementFields[k] == "hp_add_total")
                    {
                        hp_add_total = MainWindow.eLC.GetValue(12, pos_item, k);
                        break;
                    }
                }
                for (int k = 0; k < MainWindow.eLC.Lists[12].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[12].elementFields[k] == "hp_add_time")
                    {
                        hp_add_time = MainWindow.eLC.GetValue(12, pos_item, k);
                        break;
                    }
                }
                for (int k = 0; k < MainWindow.eLC.Lists[12].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[12].elementFields[k] == "mp_add_total")
                    {
                        mp_add_total = MainWindow.eLC.GetValue(12, pos_item, k);
                        break;
                    }
                }
                for (int k = 0; k < MainWindow.eLC.Lists[12].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[12].elementFields[k] == "mp_add_time")
                    {
                        mp_add_time = MainWindow.eLC.GetValue(12, pos_item, k);
                        break;
                    }
                }
                ...
                for (int k = 0; k < MainWindow.eLC.Lists[12].elementFields.Length; k++)
                {
                    if (MainWindow.eLC.Lists[12].elementFields[k] == "price")
                    {
                        string price = MainWindow.eLC.GetValue(12, pos_item, k);
                        if (price != "0")
                        {
